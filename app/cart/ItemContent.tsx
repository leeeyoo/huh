...
const ItemContent: React.FC<ItemContentProps> = ({
  ...
  return ( 
    <div className="grid grid-cols-5 text-xs md:text-sm gap-4 border-t-[1.5px] border-neutral-200 py-4 items-center">
      <div className="col-span-2 justify-self-start flex gap-2 md:gap-4">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="w-[70px]">
            <button className="text-neutral-500 underline" onClick={() => handleRemoveProductFromCart(item)}>Remove</button>
          </div>
        </div>
      </div>
